        ...
        <div className="relative z-10 flex flex-col h-full px-14 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[10px] tracking-[0.4em] uppercase" style={{ color: 'rgba(212,175,55,0.5)' }}>Est. 2005</span>
            ...
            <h1 className="font-serif text-white/90 leading-tight mb-6" style={{ fontSize: 'clamp(2rem, 3vw, 2.75rem)' }}>
              Crafted with<br />
              <span style={{ color: '#D4AF37' }}>precision.</span><br />
              Worn with pride.
            </h1>

            <p className="text-white/35 text-sm leading-relaxed mb-10 max-w-xs">
              Sign in to access your wishlist, track orders, and experience our curated collections of sterling silver and certified gemstone jewellery.
            </p>

            {/* Trust badges */}
            <div className="space-y-3">
              {[
                { icon: '✦', label: '92.5 Sterling Silver, Hallmarked' },
                { icon: '✦', label: 'Certified Gemstones' },
                { icon: '✦', label: 'Lifetime Maintenance Guarantee' },
              ].map(({ icon, label }) => (
