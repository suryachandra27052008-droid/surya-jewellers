          ...
          >
            <div className="relative">
              <div className="aspect-[4/5] bg-gray-100 flex items-center justify-center p-8 text-center border border-gray-200 rounded-2xl relative overflow-hidden">
                <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-amber-400 via-transparent to-transparent blur-3xl" />
                <div className="z-10 flex flex-col items-center">
                  ...
                  <div className="w-12 h-[1px] bg-amber-300 mb-6" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                desc: 'We exclusively set our jewellery with natural diamonds and precious gemstones, completely avoiding synthetics.',
              },
              {
