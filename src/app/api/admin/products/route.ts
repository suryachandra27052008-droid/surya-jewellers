...
export async function POST(request: Request) {
  try {
    ...
    const productData = {
      ...
      secondaryStoneType: (formData.get('secondaryStoneType') as string) || undefined,
      csWeight: formData.get('csWeight') ? Number(formData.get('csWeight')) : undefined,
      diamondWeight: formData.get('diamondWeight') ? Number(formData.get('diamondWeight')) : undefined,
      grossWeight: formData.get('grossWeight') ? Number(formData.get('grossWeight')) : undefined,
      allStones: formData.get('allStones') ? JSON.parse(formData.get('allStones') as string) : undefined,
    ...
    const newProduct = await writeClient.create({
      ...
      secondaryStoneType: productData.secondaryStoneType,
      csWeight: productData.csWeight,
      diamondWeight: productData.diamondWeight,
      grossWeight: productData.grossWeight,
      allStones: productData.allStones,
