...
const reasons = [
  ...
  },
  {
    ...
    title: 'BIS Hallmarked 92.5 Sterling Silver',
    desc: 'All pieces are crafted in certified 92.5 sterling silver and carry BIS hallmarking — giving your customers the assurance of verified quality.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
