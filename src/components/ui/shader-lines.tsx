...
export function ShaderAnimation() {
  ...
  const sceneRef = useRef<any>({ camera: null, scene: null, renderer: null, uniforms: null, animationId: null })
  useEffect(() => {
  ...
  const initThreeJS = () => {
    ...
    const fragmentShader = `
      ...
      void main(void) {
        ...
        // Gold tones: shift colors toward amber/gold
        vec3 gold = vec3(color[2]*1.2, color[1]*0.9, color[0]*0.3);
